/**
 * Génère un prompt détaillé pour définir le rôle de l'IA
 * @param prospectDescription Description dynamique du client
 * @param levelSelected Niveau de difficulté sélectionné
 * @returns Prompt structuré pour l'IA
 */
export function generatePrompt(prospectDescription: string, levelSelected: number): string {
